...
import { ShieldCheck, Check, Lock, QrCode, ArrowRight, FileEdit, Sparkles, HelpCircle, MessageSquare } from "lucide-react"
...
export function BusinessVerificationStep({
  ...
  return (
    <div className="w-full space-y-4 animate-in fade-in duration-300">
      ...
      {/* 1. Lifetime Verified Business Tag Banner Card */}
      <div className="relative overflow-hidden rounded-[20px] bg-gradient-to-br from-[#ECF8F1] via-[#F2F9F5] to-[#E6F4EA] border border-[#C5EBD6] p-4 sm:p-5 shadow-xs">
        ...
        <div className="absolute right-0 bottom-0 opacity-25 pointer-events-none transform translate-x-2 translate-y-2">
          <svg width="180" height="110" viewBox="0 0 200 120" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M145 35L149 39L156 31" stroke="#10B981" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
        ...
        <div className="relative z-10 flex items-stretch gap-3.5">
          ...
          <div className="flex flex-col items-center justify-center shrink-0 pr-2 border-r border-[#D1EAD8]">
            <div className="relative flex items-center justify-center">
              ...
              <VerifiedShieldIcon className="w-13 h-15 sm:w-14 sm:h-16 drop-shadow-xs" />
            </div>
            
            <div className="mt-1 text-center leading-none">
              <span className="block text-[10px] font-black text-[#047857] tracking-wider uppercase">LIFETIME</span>
          ...
          <div className="flex-1 min-w-0 space-y-1.5 flex flex-col justify-center">
            <h3 className="text-[16px] sm:text-[17px] font-extrabold text-[#0F172A] leading-tight tracking-tight">
              Get Your Verified Business Tag
            </h3>
            <p className="text-[12px] text-slate-600 font-medium leading-snug">
              Pay once and get lifetime verification and dashboard access.
            </p>
          ...
          <div className="flex items-start gap-3 pt-1">
            ...
            <div className="flex-1 min-w-0 pr-16">
              ...
              <p className="text-[12px] text-slate-500 font-medium">
                Create any sale agreement for just
              </p>
              <div className="mt-0.5 flex items-baseline gap-1">
                <span className="text-[24px] font-black text-[#0052CC] leading-none">₹49</span>
      ...
      >
        ...
        <span className="text-[11.5px] font-bold text-slate-700 leading-snug select-none">
          I authorize eSaleAgreement to verify my business and agree to the{" "}
      ...
      {/* 6. Primary Action CTA Button (Single Button) */}
      <button
        type="button"
        onClick={onProceed}

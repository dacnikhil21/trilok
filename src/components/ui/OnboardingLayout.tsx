...
export function OnboardingLayout({
  ...
  return (
    <div className="w-full bg-[#FAFCFF] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-teal-100/40 via-blue-50/20 to-transparent flex flex-col items-center justify-between min-h-[100dvh] pt-1 px-3.5 pb-[calc(16px+env(safe-area-inset-bottom,0px))] box-border select-none font-sans overflow-y-auto">
      
      {/* ── Native Mobile App Content Stack (Flex distribution for tall Android screens) ── */}
      <div className="w-full max-w-[420px] flex flex-col flex-1 justify-between space-y-3.5 my-0 py-1">

        {/* Top Section Stack */}
        <div className="w-full flex flex-col space-y-3.5">
          {/* Header Navbar with Separator Line */}
        ...
        {/* Bottom Section Stack (Action Button & Footer) */}
